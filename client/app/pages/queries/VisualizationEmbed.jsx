...
export default {
  ...
  render: (routeParams, currentRoute, location) => (
    <Layout.DefaultSignedOut apiKey={location.search.api_key}>
      <VisualizationEmbed key={location.path} {...routeParams} apiKey={location.search.api_key} />
    </Layout.DefaultSignedOut>
  ),
};
